...
import os, sys, doctest, traceback, urllib.request, urllib.parse, urllib.error, base64, ast, re, imp
...
def find_lines(varname):
    return list(filter(lambda l: varname in l, list(open(asgn_name+'.py'))))
